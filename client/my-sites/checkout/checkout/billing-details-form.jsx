...
import { debounce, first, includes, indexOf, intersection, isEqual, last, map, noop } from 'lodash';
...
import { addPrivacyToAllDomains, removePrivacyFromAllDomains, setBillingDetails, setDomainDetails, addGoogleAppsRegistrationData } from 'lib/upgrades/actions';
		...
		return (
			<>
				<ContactDetailsFormFields
					...
					hideFooter={ true }
				>
					{ this.needsDomainDetails() && this.renderDomainToggleCheckbox() }
				</ContactDetailsFormFields>
	...
	renderDomainPrivacy() {
		...
		return (
			<label className="checkout__domain-privacy-label">
				<FormCheckbox
					defaultChecked={ this.allDomainItemsHavePrivacy() }
